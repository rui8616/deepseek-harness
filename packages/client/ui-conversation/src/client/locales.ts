...
const PLAN_NEXT_ACTION_JA = 'タスクを説明するとプランを生成します'
...
export const ja = {
  ...
  'hint.goal.active': '目標が進行中です。edit で編集 / pause で一時停止 / resume で再開 / clear で解除',
  'placeholder.plan': PLAN_NEXT_ACTION_JA,
  'placeholder.default': 'メッセージを送るかタスクを依頼… / コマンド、@ でファイルや会話を参照',
  'placeholder.unavailable': 'セッションを利用できません',
  'placeholder.parentOffline': '親セッションがオフラインのため送信できません。実行中の処理は停止できます',
  'placeholder.hero': '作りたいものを説明してください… / コマンド、@ でファイルや会話を参照',
  ...
  'attachment.dropTitle': 'ファイルや画像をここにドラッグすると追加できます',
  'attachment.dropDesc': '画像の制限：最大 {count} 枚、1 枚あたり {size}',
  'attachment.dropBlocked': '現在ファイルや画像を追加できません',
  'image.pending': '送信待ちの画像',
  'image.openOriginal': '原寸画像を表示',
  'image.openOriginalLabel': '{label}、クリックで原寸画像を表示',
  'image.remove': '画像 {name} を削除',
  'image.original': '原寸画像',
  'image.label': '画像',
  'image.loadFailed': '画像の読み込みに失敗しました。クリックで再試行',
  'image.loading': '画像を読み込み中…',
  'image.preview': '原寸画像のプレビュー',
  'image.closePreview': '原寸画像のプレビューを閉じる',
  'image.unsupportedType': '対応している画像形式は PNG、JPG、WebP、GIF のみです',
  'image.tooMany': '1 通のメッセージに追加できる画像は最大 {count} 枚です',
  'image.fileTooLarge': '画像 1 枚あたり {size} を超えることはできません',
  ...
  'image.sendFailed': '画像の送信に失敗しました（{reason}）。画像を追加し直してから再試行してください',
  ...
  'file.notStaged': 'ファイルのアップロードが完了していません。追加し直してから再試行してください',
  'file.label': 'ファイル',
  ...
  'settings.enter.description': 'エージェントの実行中のみ有効です。Cmd/Ctrl+Enter はもう一方の動作になります',
  'settings.enter.queue': 'キューに追加',
  'settings.enter.steer': '割り込み送信',
  'access.preset.readOnly': '閲覧のみ',
  'access.preset.workspaceWrite': 'ワークスペース内で変更',
  'access.preset.fullAccess': 'フルアクセス',
  'access.confirm.title': 'フルアクセスを有効にしますか？',
  'access.confirm.description': 'フルアクセスを有効にすると、エージェントは確認の手順を減らし、機微な操作、ファイルの変更、外部コマンドの実行を含む多くの操作を直接実行できるようになります。現在のタスクを信頼できる場合にのみ使用してください。',
  ...
  'todo.progress.pending': '{pending} 件未着手',
  'todo.rowTitle': 'タスクリストを更新',
  'todo.completed': '{done}/{total} 件完了',
  'command.attachmentsUnsupported': '/{command} は添付ファイルを受け付けません。先に削除してください',
  'ask.rowTitle': '質問',
  'ask.waiting': '回答待ち',
  'ask.cancelled': 'キャンセル済み',
  'ask.cancelledDetail': 'このターンはキャンセルされ、回答は送信されていません',
  'ask.interrupted': '中断済み',
  'ask.interruptedDetail': 'このターンは中断され、回答は送信されていません',
  'ask.answered': '{answered}/{total} 件回答済み',
  'ask.skipped': '未回答',
  'bash.running': '実行中',
  'bash.failed': '失敗',
  'bash.stopped': '停止しました',
  ...
  'web.sourcesTruncated': '出典の一覧は省略されています',
  'web.http': 'HTTP',
  ...
  'queue.edit.unsupported': 'テキスト以外の内容を含むため、編集できません',
  'queue.save': 'キュー内メッセージを保存',
  'queue.cancelEdit': '編集をキャンセル',
  'queue.remove': 'キュー内メッセージを削除',
  'queue.steer': '割り込み送信',
  'queue.steer.unavailable': '割り込み送信は実行中のみ利用できます',
  'queue.editFailed': '編集に失敗しました。このメッセージは既に送信が始まっている可能性があります。',
  'queue.removeFailed': '削除に失敗しました。このメッセージは既に送信が始まっている可能性があります。',
