...
export const ja: Record<SubagentKey, string> = {
  ...
  'diagnostic.unsupported': 'サブエージェント記録のバージョンがサポートされていません',
  ...
  'duration.exactTitle': '合計稼働時間：{duration}',
  'tokens.thousand': '{value}K',
  'tokens.million': '{value}M',
  'tokens.total': '{value} tok',
  ...
  'branch.collapse': '{label} の配下を折りたたむ',
  'branch.expand': '{label} の配下を展開',
  ...
  'readonly.oneShot.body': '単発タスクは追加のメッセージを受け付けません。ここで実行記録の全体を確認できます。',
  'readonly.body': '親セッションがオフラインです。親セッションを開き直すとメッセージを送信できます。',
}
