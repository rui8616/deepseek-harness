...
export const ja: Record<AgentPresetSettingsKey, string> = {
  error: 'Agent プリセットを読み込めませんでした。',
  userTrust: 'カスタム',
  seatHint: 'これから開始するセッションで使用する Agent プリセット',
  headerHint: 'このセッションが実行している Agent プリセット。開始時に固定されます',
  nav: 'Agent プリセット',
  sectionIntro: 'プリセットとは、1 つのセッションの Agent が実行するプラグイン構成、つまりツール・プロンプト・機能のことです。既存のものを複製して自分用に変更するか、「クリエイターモード」で Agent に作成させることができます。',
  builtIn: '組み込み',
  setDefault: '既定に設定',
  view: '表示',
  presetStandardName: '標準モード',
  presetStandardDescription: 'ファイル編集、シェル、ファイルと Web の検索、Skills、プラン、ゴール、サブエージェント、ワークフローを備えた、機能完全なコーディング Agent。',
  presetPtcName: 'PTC モード',
  presetPtcDescription: '機能完全なコーディング Agent。workflow ツールは含まれず、その他のツールは PTC モード SDK 経由で公開されるため、モデルは 1 つの TypeScript プログラムで複数の操作を組み合わせられます。',
  presetMinimalName: 'ミニマルモード',
  presetMinimalDescription: '永続 bash と str_replace_editor の 2 ツールだけを備えたコーディング Agent。',
  presetCordisName: 'クリエイターモード',
  presetCordisDescription: 'カスタム Agent プリセットの作成用。標準モードの全機能に加えて、ランタイムの調査、プラグインの実験、プリセット作成のガイダンスを提供します。',
  duplicate: '複製',
  ...
  presetIdPlaceholder: 'my-agent',
  displayName: '名前',
  displayNamePlaceholder: 'ピッカーに表示される名前。既定では識別子が使われます',
  inUse: '使用中',
  builtInGroup: '組み込み',
  customGroup: 'カスタム',
  ...
  retry: '再試行',
  copyTitle: 'プリセットを複製',
  copyIntro: 'プリセット全体がこのマシン上に複製されます。識別子はディレクトリ名になり、後から変更できません。それ以外はプリセット自身のファイルで編集します。',
  create: '作成',
  creating: '作成中…',
  creatorDraft: 'クリエイターモードでカスタムプリセットを作成',
  openLocation: 'フォルダーを開く',
  showLocation: '場所を表示',
  revealedPathLabel: 'プリセットのファイル：',
  idRequired: 'プリセットの識別子を入力してください。',
  idInvalid: '小文字、数字、ハイフンのみ使用でき、先頭は文字か数字にしてください。',
  idTaken: 'この識別子のプリセットはすでに存在します。',
  deleteTitle: 'このプリセットを削除しますか？',
  deleteDescription: 'プリセットのディレクトリが削除されます。すでに実行中のセッションはそのまま動作しますが、新しいセッションでは選択できなくなります。',
  deleteConfirm: '削除',
  deleting: '削除中…',
}
